...
const (
	...
	WorldServerService_CanTurnInGuildPetition_FullMethodName          = "/v1.WorldServerService/CanTurnInGuildPetition"
)
...
type WorldServerServiceClient interface {
	...
	// Petitions
	CanTurnInGuildPetition(ctx context.Context, in *CanTurnInGuildPetitionRequest, opts ...grpc.CallOption) (*CanTurnInGuildPetitionResponse, error)
}
...
func (c *worldServerServiceClient) CanTurnInGuildPetition(ctx context.Context, in *CanTurnInGuildPetitionRequest, opts ...grpc.CallOption) (*CanTurnInGuildPetitionResponse, error) {
	out := new(CanTurnInGuildPetitionResponse)
	err := c.cc.Invoke(ctx, WorldServerService_CanTurnInGuildPetition_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorldServerServiceServer interface {
	...
	// Petitions
	CanTurnInGuildPetition(context.Context, *CanTurnInGuildPetitionRequest) (*CanTurnInGuildPetitionResponse, error)
...
func (UnimplementedWorldServerServiceServer) CanTurnInGuildPetition(context.Context, *CanTurnInGuildPetitionRequest) (*CanTurnInGuildPetitionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CanTurnInGuildPetition not implemented")
}
...
func _WorldServerService_CanTurnInGuildPetition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CanTurnInGuildPetitionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorldServerServiceServer).CanTurnInGuildPetition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WorldServerService_CanTurnInGuildPetition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorldServerServiceServer).CanTurnInGuildPetition(ctx, req.(*CanTurnInGuildPetitionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WorldServerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CanTurnInGuildPetition",
			Handler:    _WorldServerService_CanTurnInGuildPetition_Handler,
		},
	},
